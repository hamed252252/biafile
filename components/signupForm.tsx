  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 dark:bg-gradient-to-r dark:from-purple-800 dark:via-indigo-700 dark:to-blue-800">
      ...
      >
        ...
        {[
          ...
          <div key={field.name} className="mb-5">
            ...
            <Input
              ...
              className={cn(
                'w-full p-3 border rounded-lg mt-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white',
        ...
        <Button
          type="submit"
          className="w-full py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 transition duration-300"
        >
          ثبت‌نام
        </Button>
