    ...
    return (
        <div>
            <div className="flex justify-center items-center relative bg-gradient-to-r from-[#3064C0] to-[#172F5A] w-full h-[30vh]">
                ...
                <div className="bg-white border drop-shadow-md w-[70vw] h-[40vh] md:h-48 absolute top-44 rounded-2xl flex justify-center items-center flex-col md:flex-row text-slate-600 gap-y-10">
