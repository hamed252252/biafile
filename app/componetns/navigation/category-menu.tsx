...
import { Menu as MenuIcon, X as CloseIcon, ChevronDown, Search } from 'lucide-react';
    ...
    <nav className="relative z-50 dark:bg-gray-900">
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="hidden md:flex items-center space-x-8 rtl:space-x-reverse">
          {categories.map((cat, idx) => (
            ...
            >
              <button className="flex items-center space-x-1 rtl:space-x-reverse text-gray-700 dark:text-gray-200 hover:text-blue-600 transition">
                ...
                {cat.subResultCategorys.length > 0 && (
                  <motion.span
                    animate={{
              ...
              <AnimatePresence>
                {openIndex === idx && cat.subResultCategorys.length > 0 && (
                  <motion.div
                    initial={{
                      opacity: 0,
                      y: 10,
          ...
          <div
            className="relative"
            onMouseEnter={() => setOpenIndex(categories.length)}
            onMouseLeave={() => setOpenIndex(null)}
          >
            <button className="flex items-center space-x-1 rtl:space-x-reverse text-gray-700 dark:text-gray-200 hover:text-blue-600 transition">
              <span>بیشتر</span>
              <motion.span
                animate={{
                  rotate: openIndex === categories.length ? 180 : 0,
                }}
                transition={{
                  duration: 0.2,
                }}
            ...
            >
              ...
              <div className="overflow-auto flex-1 space-y-2">
                ...
                <div className="mt-4 space-y-2 w-full">
                  <Link href="/aboutus" className="block py-2 px-2 hover:text-blue-600 transition">
                    درباره ما
                  </Link>
                  <Link
                    href="/contactus"
                  ...
                  <Link href="/blog" className="block py-2 px-2 hover:text-blue-600 transition">
                    مجله
                  </Link>
                </div>
              </div>
