  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        {/* تماس با ما */}
        <FooterSection title="تماس با ما" href="/contactus">
          <motion.div
        ...
        {/* درباره ما */}
        <FooterSection title="درباره ما" href="/aboutus">
          <motion.p
        ...
        >
          <h3 className="text-xl font-semibold">ما را دنبال کنید</h3>
...
const FooterSection: React.FC<FooterSectionProps> = ({ title, href, children }) => (
