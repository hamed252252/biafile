...
export default function Component() {
  ...
  return (
    <div dir="rtl" className="container mx-auto p-4 space-y-6">
      <h1 className="text-3xl font-bold text-center mb-6">اعتبار اصلی شما</h1>

      <div className="flex justify-end">
        <Select dir="rtl" defaultValue={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger className="w-[180px]">
            <SelectValue placeholder="انتخاب بازه زمانی" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="1m">۱ ماه گذشته</SelectItem>
            <SelectItem value="3m">۳ ماه گذشته</SelectItem>
            <SelectItem value="6m">۶ ماه گذشته</SelectItem>
            <SelectItem value="1y">۱ سال گذشته</SelectItem>
          </SelectContent>
        </Select>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>روند موجودی حساب در بازه زمانی انتخاب شده</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>مقایسه درآمد و هزینه در بازه زمانی انتخاب شده</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={incomeVsExpenseData}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="income" fill="#8884d8" name="درآمد" />
                <Bar dataKey="expense" fill="#82ca9d" name="هزینه" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
      ...
      <Card dir="rtl">
        ...
        <CardContent>
          <Tabs dir="rtl" defaultValue="income">
            ...
            <TabsContent value="income">
              <p className="text-sm text-muted-foreground mt-4">
                بیشترین منبع درآمد شما در ماه گذشته: واریز حقوق (۶۰٪ کل درآمد)
              </p>
            </TabsContent>
            <TabsContent value="expense">
              <p className="text-sm text-muted-foreground mt-4">
                بیشترین هزینه شما در ماه گذشته: خرید مواد غذایی (۳۰٪ کل هزینه‌ها)
              </p>
            </TabsContent>
          </Tabs>
        </CardContent>
