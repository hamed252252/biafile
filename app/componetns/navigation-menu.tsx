      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          <Link href="/" className="flex items-center">
            <Image src={logoImage} alt="بیافایل" width={40} height={40} />
            <span className="ml-2 text-2xl font-bold text-gray-800 dark:text-white">بیافایل</span>
          </Link>
        </motion.div>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                <span className="text-lg font-semibold text-gray-800 dark:text-gray-100">منو</span>
              ...
              <div className="overflow-auto p-4 space-y-4">
                ...
                <Button className="w-full" variant="ghost" onClick={toggleDarkMode}>
